...
void addPinSelect(boolean forI2C, String& str, String name,  int choice){return;}
void addTaskSelect(String& str, String name,  int choice){return;}
void addTaskValueSelect(String& str, String name,  int choice, byte TaskIndex){return;}
#endif
